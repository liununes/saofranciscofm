...
CREATE TABLE public.radio_config (
  ...
  streaming_url_backup TEXT DEFAULT 'http://streaming.liurecord.com.br:8015/',
  streaming_backup_enabled BOOLEAN NOT NULL DEFAULT false,
  streaming_failover_mode TEXT NOT NULL DEFAULT 'manual',
  streaming_active_source TEXT NOT NULL DEFAULT 'primary',
